...
|---------|-------------|---------------|
| admin.md（backlogサブコマンド） | deal | Backlogプロジェクト設定管理 |
| admin.md（indexサブコマンド） | deal | INDEX再構築 |
| admin.md（kpi-setサブコマンド） | deal | 参照ファイル kpi-format.md |
| admin.md（migrateサブコマンド） | deal | フォーマットマイグレーション |
...
| doc.md（全種別共通） | deal | ガイドライン参照による業務ドキュメント生成 |
| engdoc.md（全種別共通） | deal | ガイドライン参照による業務ドキュメント生成 |
| knowledge/save.md | knowledge | ナレッジ保存 |
| knowledge/search.md | knowledge | ナレッジ検索 |
| log.md（dailyサブコマンド） | deal | 日次活動ログ |
| log.md（reportサブコマンド） | deal | 活動レポート生成 |
